...
@WebServlet("/ch06/requsetMethod2")
public class Ex01_RequsetMethod2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/ch06/requsetMethod.jsp");
		rd.forward(req, res);
	}
