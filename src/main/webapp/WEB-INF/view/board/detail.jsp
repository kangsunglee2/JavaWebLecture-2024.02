    	 	...
    	 	<div class="col-9">
	    		<h3><strong class="me-5">게시글 보기</strong>
					<span style="font-size:16px">
	    				<a href="/jw/bbs/board/list?p=${currentBoardPage}&f=${field}&q=${qurey}"><i class="fa-solid fa-table-list"></i>목록</a>
	    			<c:if test="${sessUid eq board.uid or sessUid eq 'admin'}">	<!-- 본인만 수정/삭제 가능 -->
