    	 	...
    	 	<div class="col-9">
    	 			...
    	 			<tr>
    	 				<td style="width: 52%; text-align: left">
				    		<h3><strong class="me-5">게시글 목록</strong>
					        	<span style="font-size: 16px"><a href="/jw/bbs/board/insert"><i class="fa-solid fa-pen-to-square me-1"></i>글 쓰기</a></span>	    		
				    		</h3>
    	 				</td>
    	 				<td style="width: 16%">
	        	...
	        	<ul class="pagination justify-content-center mt-4">
					...
					<li class="page-item ${currentBoardPage eq page ? 'active' : ''}">
						<a class="page-link" href="/jw/bbs/board/list?p=${page}&f=${filed}&q=${query}">${page}</a>
					</li>
					</c:forEach>
